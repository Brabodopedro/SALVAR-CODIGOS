...
somaquadrados = (prova1 - media)**2 + (prova2 - media)**2 + (prova3 - media)**2 + (prova4 - media)**2
# Passo 2.4. Calcule a variância
variancia = somaquadrados/4
...
# pós: media == Soma i em {1,2,3,4}: prova[i] 
# && varianca == ((1/n)(Soma i em {1,2,3,4}: (prova[i])^2) - 
